...
class ScienceIE_selection_preprocessing(object):
    ...
    def _one_pass_train(self):
        # prepare for char_vocab, word_vocab, relation_vocab
    ...
    def gen_vocab(self, min_freq: int):
        ...
        target = os.path.join(self.data_root, 'char_vocab.json')
        result = {'<pad>': 0}
        i = 1
